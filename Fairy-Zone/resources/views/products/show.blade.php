<x-app-layout :title="$product->name . ' — Fairy Zone'">
    ...
    <div class="max-w-5xl mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
                {{-- Main Image --}}
                <div class="aspect-square bg-gray-50 border border-gray-100 rounded-xl overflow-hidden mb-3">
            ...
            <div>
                ...
                @else
                    <p class="text-sm text-red-400 mb-6">Out of stock</p>
                @endif
                ...
                @if($product->description)
                    <div class="mt-8 pt-8 border-t border-gray-100">
                        <h2 class="text-sm font-medium text-gray-800 mb-3">Description</h2>
